...
public class FeatureController {
	...
	public Sentence getFeaturePara(String paragraph){
	    ...
	    sentence.setCnt_modifier((double)PDTO.getCnt_modifier()/2177);
	    sentence.setLength((double)PDTO.getLength()/24558);
	    sentence.setWord((double)PDTO.getWord()/4419);
	    sentence.setAvg_char((double)PDTO.getNumChar()/7);
	    sentence.setAvg_syllables((double)PDTO.getNumSyll()/(float)2.3);
	    sentence.setVoca_score((double)PDTO.getVoca_score()/(float)30.7);
	    ...
	    sentence.setCnt_sbar((double)PDTO.getNumSBAR()/234);
	    sentence.setCnt_compound((double)PDTO.getNumCompound()/146);
	    sentence.setCnt_gr((double)PDTO.getNumGR()/4718);
	    sentence.setAvg_dis_gr((double)PDTO.getAvg_dist_GR()/(float)31.3);
	    sentence.setMax_dis_gr((double)PDTO.getMax_dist_GR()/65.5);
	...
	public Sentence getFeatureSentence(String sen){
	    ...
	    sentence.setCnt_modifier((double)SenFeature.getCnt_modifier()/100);
	    sentence.setLength((double)SenFeature.getLength()/1306);
	    sentence.setWord((double)SenFeature.getWord()/191);
	    ...
	    sentence.setVar_modifier((double)SenFeature.getModifierVar()/(float)2.7);
	    ...
	    sentence.setCnt_gr((double)SenFeature.getNumGR()/191);
	    sentence.setAvg_dis_gr((double)SenFeature.getAvg_dist_GR()/96);
	    sentence.setMax_dis_gr((double)SenFeature.getMax_dist_GR()/191);
